/* 
    ...
    Date Updated: 
    Version: 1.0 
    Purpose: MIS 3371 Homework 4 to learn how to use JavaScript and create a patient form. 
*/
...
// try/Catch Error for State Dropdown adapted with example from W3Schools
async function getStates()
{
    try
    {
        let statesFile = await fetch("states.html");
            if (!statesFile.ok)
            {
                throw new Error("States file could not be found.");
            }
        let states = await statesFile.text();
...
//--------------------------------------------------------------------------------------------------------------------------
//COOKIE
//Cookie functions adapted from W3Schools examples.
...
function checkCookie()
{
    ...
    if (firstname != "")
    {
        ...
        document.getElementById("newUserMessage").hidden = false;
    }
    else
    {
        document.getElementById("welcomeMessage").innerHTML =
            "Welcome New User";
        document.getElementById("newUserMessage").hidden = true;
    }
}
function saveCookie()
{
...
//--------------------------------------------------------------------------------------------------------------------------
//LOCAL STORAGE
//Local storage format adapted from W3Schools examples.
function saveLocalStorage()
{
    ...
    if (remember == true)
    {
        ...
        if (document.getElementById("vac_yes").checked)
            {
                localStorage.setItem("vaccinated", "Yes");
            }
            else if (document.getElementById("vac_no").checked)
            {
                localStorage.setItem("vaccinated", "No");
            }

            if (document.getElementById("insur_yes").checked)
                {
                    localStorage.setItem("insurance", "Yes");
                }
                else if (document.getElementById("insur_no").checked)
                {
                    localStorage.setItem("insurance", "No");
                }

        localStorage.setItem("influenza", document.getElementById("influenza").checked);

        localStorage.setItem("strep_throat", document.getElementById("strep_throat").checked);

        localStorage.setItem("stomach_flu", document.getElementById("stomach_flu").checked);

        localStorage.setItem("bronchitis", document.getElementById("bronchitis").checked);

        localStorage.setItem("pneumonia", document.getElementById("pneumonia").checked);
...
function loadLocalStorage()
{
    ...
    let vaccinated = localStorage.getItem("vaccinated");
        ...
        if (vaccinated == "Yes")
        {
            document.getElementById("vac_yes").checked = true;
        }
        else if (vaccinated == "No")
        {
            document.getElementById("vac_no").checked = true;
        }
        ...
        if (insurance == "Yes")
        {
            document.getElementById("insur_yes").checked = true;
        }
        else if (insurance == "No")
        {
            document.getElementById("insur_no").checked = true;
        }

    document.getElementById("influenza").checked = localStorage.getItem("influenza") == "true";

    document.getElementById("strep_throat").checked = localStorage.getItem("strep_throat") == "true";

    document.getElementById("stomach_flu").checked = localStorage.getItem("stomach_flu") == "true";

    document.getElementById("bronchitis").checked = localStorage.getItem("bronchitis") == "true";

    document.getElementById("pneumonia").checked = localStorage.getItem("pneumonia") == "true";

    document.getElementById("pain").value = localStorage.getItem("pain");

    document.getElementById("painlevel").innerHTML = localStorage.getItem("pain");
}
//--------------------------------------------------------------------------------------------------------------------------
...
/*
MIS 3371 Homework 4 examples provided by Professor Jake Messinger.
